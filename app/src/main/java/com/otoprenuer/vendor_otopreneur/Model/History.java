...
public class History {
    ...
    public History(Integer id, Integer invoiceNo, String venicheType, Integer customer, String location, String note, Integer vendor, Object price, Object duration, String time, String service, String venichleSeries, String status, Customerdata customerdata, Vendordata vendordata) {
        this.id = id;
